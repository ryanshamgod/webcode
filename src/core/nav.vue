<template>
  <el-menu :default-active.sync="activeLink" :mode="mode" @select="goto" :collapse="isCollapse" :unique-opened="true" background-color="transparent" class="main-navigation-menu" :class="{ 'nav-collapsed': isCollapse }">
    ...
    <el-submenu index="/dashboards" popper-class="main-navigation-submenu">
      <template slot="title"> <i class="mdi mdi-gauge"></i><span>Dashboard</span> </template>
    ...
    <el-menu-item index="/gallery"> <i class="mdi mdi-image-multiple"></i><span slot="title">Gallery</span> </el-menu-item>
    <el-menu-item index="/student"> <i class="mdi mdi-card-account-details"></i><span slot="title">Student Information</span> </el-menu-item>
    <el-menu-item index="/studentlist"> <i class="mdi mdi-clipboard-list"></i><span slot="title">Student List</span> </el-menu-item>
    <el-menu-item index="/cards"> <i class="mdi mdi-view-dashboard"></i><span slot="title">Cards</span> </el-menu-item>
    <el-menu-item index="/timeline"> <i class="mdi mdi-source-commit-local"></i><span slot="title">Timeline</span> </el-menu-item>
    ...
    <el-submenu index="/ecommerce" popper-class="main-navigation-submenu">
      <template slot="title"> <i class="mdi mdi-cart-outline"></i><span>eCommerce</span> </template>
      <el-menu-item index="/ecommerce/dashboard">
    ...
    <el-submenu index="layout" popper-class="main-navigation-submenu">
      <template slot="title"> <i class="mdi mdi-view-quilt"></i><span>Layout</span> </template>
    ...
    <el-submenu index="1" popper-class="main-navigation-submenu" popper-append-to-body>
      <template slot="title"> <i class="mdi mdi-menu"></i><span>Multi level menu</span> </template>
    ...
    <el-submenu index="icons" popper-class="main-navigation-submenu">
      <template slot="title"> <i class="mdi mdi-folder-image"></i><span>Icons</span> </template>
    ...
    <el-menu-item index="/helper-classes"> <i class="mdi mdi-help-circle-outline"></i><span slot="title">Helper Classes</span> </el-menu-item>
    <el-submenu index="element" popper-class="main-navigation-submenu limit-height">
      <template slot="title"> <i class="mdi mdi-shape"></i><span>Element</span> </template>
    ...
    <el-submenu index="tables" popper-class="main-navigation-submenu">
      <template slot="title"> <i class="mdi mdi-table"></i><span>Tables</span> </template>
    ...
    <el-submenu index="maps" popper-class="main-navigation-submenu">
      <template slot="title"> <i class="mdi mdi-map-marker-radius"></i><span>Maps</span> </template>
    ...
    <el-submenu index="editors" popper-class="main-navigation-submenu">
      <template slot="title"> <i class="mdi mdi-pencil-box"></i><span>Editors</span> </template>
    ...
    <el-submenu index="charts" popper-class="main-navigation-submenu">
      <template slot="title"> <i class="mdi mdi-chart-areaspline"></i><span>Charts</span> </template>
    ...
    <el-menu-item index="/profile"> <i class="mdi mdi-card-account-details"></i><span slot="title">Profile</span> </el-menu-item>
    <el-submenu index="authentication" popper-class="main-navigation-submenu">
      <template slot="title"> <i class="mdi mdi-lock"></i><span>Authentication</span> </template>
    ...
    <el-menu-item index="/invoice"> <i class="mdi mdi-file-document"></i><span slot="title">Invoice</span> </el-menu-item>
    <el-menu-item index="/404"> <i class="mdi mdi-alert-octagon"></i><span slot="title">404</span> </el-menu-item>
  </el-menu>
</template>
