<template>
  <div class="page-table column scrollable only-y" :class="{ flex: !isMobile, overflow: isMobile }">
    <div class="page-header header-primary card-base card-shadow--small" style="margin: 0px">
      <h1>Student List</h1>
      <h4 v-if="$route.meta.showSub === true">sub header</h4>
      <el-breadcrumb separator="/">
        <el-breadcrumb-item :to="{ path: '/' }"><i class="mdi mdi-home-outline"></i></el-breadcrumb-item>
        <el-breadcrumb-item>apps</el-breadcrumb-item>
        <el-breadcrumb-item>Student List</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    ...
    <div class="table-box card-base card-shadow--medium box grow" id="table-wrapper" v-loading="!ready">
      ...
      <el-pagination v-if="ready" :small="pagination.small" :current-page.sync="pagination.page" :page-sizes="pagination.sizes" :page-size.sync="pagination.size" :layout="pagination.layout" :total="total"></el-pagination>
    </div>
  </div>
</template>
