<template>
  <div class="page-profile-edit scrollable only-y">
    <div class="page-header header-primary card-base card-shadow--small" style="margin-bottom: 20px">
      <h1>
        Student Information
      ...
      <h4 v-if="$route.meta.showSub === true">sub header</h4>
      ...
      <el-col>
        <el-col :span="12" :md="12" :sm="24" :xs="24" class="col-p">
          <el-form-item label="Hobbies">
            <el-select class="select-wide" v-model="form.hobbies" multiple filterable allow-create default-first-option placeholder="Choose tags for your hobbies">
        ...
        <el-col :span="12" :md="12" :sm="24" :xs="24" class="col-p">
          <el-form-item label="Skills">
            <el-select class="select-wide" v-model="form.skills" multiple filterable allow-create default-first-option placeholder="Choose tags for your skills">
