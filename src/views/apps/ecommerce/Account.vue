<template>
	<vue-scroll class="page-ecommerce-account">
							...
							<div class="card-base card-outline p-20 mb-20 widget-order">
								...
								<div class="flex">
									...
									<div class="box grow flex column justify-center" @click="activeTab = 'orders'">
										...
										<div class="date">delivery date <strong>{{deliveryDate}}</strong></div>
									</div>
								</div>
							</div>
						</el-col>
					...
					<div class="orders-tab">
						<div class="order-wrapper" v-for="o in orders" :key="o.id">
							<div class="order card-shadow--small" :class="{'open':o.open}" @click="o.open = !o.open;">
								<div class="flex">
									<div class="status">
										<el-progress type="circle" :percentage="o.status" :status="o.status === 100 ? 'success' : null" :width="80"></el-progress>
									</div>
	...
	methods: {
		initOrdersData() {
			...
			_.times(50, (number) => {
				...
				this.orders.push({
					date: moment(chance.date({year: year})).format('DD MMM YYYY'),
