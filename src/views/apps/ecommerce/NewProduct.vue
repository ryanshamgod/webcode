								...
								<el-row>
									<el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">
										<div class="number-input">
											<label>Price ($)</label>
											<el-input-number v-model="price" controls-position="right" :min="1" class="themed mr-10 mb-10"></el-input-number>
										</div>
									</el-col>
									<el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">
										<div class="number-input">
											<label>Discount (%)</label>
											<el-input-number v-model="discount" controls-position="right" :min="1" class="themed mr-10 mb-10"></el-input-number>
										</div>
									</el-col>
									<el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">
										<div class="number-input">
											<label>Stock</label>
											<el-input-number v-model="stock" controls-position="right" :min="1" class="themed mr-10 mb-10"></el-input-number>
										</div>
									</el-col>
								</el-row>
								<el-row>
									<el-col class="final-price">
										final price: <strong>$ {{finalPrice}}</strong>, discount: <strong>$ {{discountPrice}}</strong>
									</el-col>
								</el-row>
								<el-row>
									<el-col class="description-box">
										<textarea-autosize v-model="description" placeholder="Description" :min-height="100"></textarea-autosize>
									</el-col>
								</el-row>
								<el-row :gutter="20">
									<el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12">
										<div class="select-box mb-10">
											...
											>
												<el-option v-for="(i, index) in cat_list" :key="index" :label="i" :value="kebabCase(i)"></el-option>
								...
								<el-row>
									<el-col>
										<div class="actions-box text-right">
											<el-switch v-model="active" active-text="Active" inactive-text="" class="mr-20 themed"></el-switch>
											<el-button class="themed mb-10 mr-10" type="primary" plain><i class="mdi mdi-content-save"></i> Save</el-button>
