<template>
	<vue-scroll class="page-ecommerce-cart">
					...
					<el-col v-for="i in cart" :key="i.id">
						<div class="item mb-20 flex card-shadow--small b-rad-4">
							...
							<div class="box grow flex center text-center">
								<div>
									<span class="ics">X</span> <el-input-number v-model="i.qnt" controls-position="right" :min="1" class="themed ml-10"></el-input-number>
								</div>
							</div>
